...
(function($){
	...
	Redactor.prototype = {
		...
		shortcuts: function()
		{
			$(this.doc).keydown($.proxy(function(e)
			{
				...
				if (e.ctrlKey) 
				{
					...
					{
						this._shortcuts(e, 'underline'); // Ctrl + u
					}
					else if (key === 73)
					{
		...
		{
			var allowed = ["code", "span", "div", "label", "a", "br", "p", "b", "u", "i", "del", "strike", "img", "video", "audio", "iframe", "object", "embed", "param", "blockquote", "mark", "cite", "small", "ul", "ol", "li", "hr", "dl", "dt", "dd", "sup", "sub", "big", "pre", "code", "figure", "figcaption", "strong", "em", "table", "tr", "td", "th", "tbody", "thead", "tfoot", "h1", "h2", "h3", "h4", "h5", "h6"];

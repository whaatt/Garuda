...
function go_welcome(fade = 0){message('welcome.php','content',0,0,1,[], function(){message('menu.php','navigation',0,0,fade,[po(['link'],['Welcome'])]);});}

function go_dashboard(fade = 0){message('dashboard.php','content',0,0,1,[], function(){message('menu.php','navigation',0,0,fade,[po(['link'],['Dashboard'])]);});}

...
function fancy_tossups(id){$('#'+id).dataTable({"bJQueryUI":true,"sPaginationType":"full_numbers","oLanguage":{"sZeroRecords":"No tossups found! You may want to create a new tossup."},"aoColumnDefs":[{"sType":"numeric","aTargets":[0]}]});}
function fancy_bonuses(id){$('#'+id).dataTable({"bJQueryUI":true,"sPaginationType":"full_numbers","oLanguage":{"sZeroRecords":"No bonuses found! You may want to create a new bonus."},"aoColumnDefs":[{"sType":"numeric","aTargets":[0]}]});}
function fancy_questions(id){$('#'+id).dataTable({"bJQueryUI":true,"sPaginationType":"full_numbers","oLanguage":{"sZeroRecords":"No promoted questions found. You may want to do so."},"aoColumnDefs":[{"sType":"numeric","aTargets":[0]}]});}
function fancy_packets(id){$('#'+id).dataTable({"bJQueryUI":true,"sPaginationType":"full_numbers","oLanguage":{"sZeroRecords":"No packets found. You can create one above on this page."},"aoColumnDefs":[{"sType":"numeric","aTargets":[0]}]});}

...
$conf['email'] = "admin@skalon.com"; //Website Email Address
...
$conf['register'] = "<p>The form below will allow you to register for a " . $conf['name'] . " account. Your username, password, and name must be between five and twenty characters (between one and forty for the latter). Passwords should match. Please note your login information carefully, and remember that it is good practice to use your real name. Emails are limited to 500 characters, more or less, and should be valid to use the forgot-your-password feature. You will only be able to submit your credentials when all of the fields have been filled out. Thanks for your understanding!</p>";//Registration
$conf['forgot'] = "<p>The form below will allow you to recover your username or password. To recover a username, simply enter your email address and leave the username field blank. If you forgot your password, you must enter <b>both</b> your username and email address to receive temporary credentials at your email. Please note that the usage of this feature is contingent on you having entered an email address with your account information.</p>";//Forgot Your Password
$conf['login'] = "<p>You may log into " . $conf['name'] . " below. Please use the Forgot tab in the menu if you have forgotten any part of your login. You will receive the appropriate credentials at the email address associated with your account. If the problem is still not resolved, contact me. Sorry about any inconvenience!</p>";//Login
...
$conf['account'] = "<p>The form below will allow you to edit your account information. Your username is listed in the upper right-hand corner of the page, and cannot be edited for security purposes. If you have an important need to change your username, please contact me with an explanation of your case, and I will definitely consider it. Your name (pre-filled) is modifiable, and you may set a new password, but your current password must validate exactly. Thank you!</p><p><b>Please note that you do not have to change your password when you submit this form, and you may leave the pertinent fields blank.</b> Whatever you input as your name, whether it was pre-filled or edited, will be updated in the database; you may simply leave the name field as-is and only change your password, if you would prefer that. Also note that the standard name and password requirements, as described at registration, are in effect.</p>";

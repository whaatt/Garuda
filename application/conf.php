...
$conf['create'] = "<p>The form below will allow you to create a new set of tournament packets. You must enter a tournament name, and one that is fewer than two hundred characters. You do not have to necessarily provide a target date. If this is a set for private use and testing, please check the appropriate box. Finally, the tournament info box is where you can write a short description of your set. This must be fewer than one thousand characters. Thank you!</p>";

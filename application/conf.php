...
$conf['create'] = "<p>The form below will allow you to create a new set of tournament packets. You must enter a tournament name that is fewer than two hundred characters long. You do not have to necessarily provide a target date. If this is a set for private use and testing, please check the appropriate box. Finally, the tournament info box is where you can write a short description of your set. This must be fewer than one thousand characters. Thank you!</p><p>In the subject selection field, you can list up to ten disciplines into which your tournament's questions will fit. Simply type the names of the topics on separate lines, and please keep these names under fifty characters. You may complete or change this information later, if you'd prefer to do that. Also, setting the allocation and distribution of these subjects will be possible at the time you generate your tournament's packets for print or download.</p>";//Creation
$conf['join'] = "<p>The form below will allow to join a previously created tournament. You must type the tournament's name exactly as it was created; please contact your tournament director to obtain this. You must then type a valid access code for the set, also provided by your tournament director. If the tournament name and code validate, you will be successfully added to the tournament with the appropriate permissions, based on the access code. Thanks!</p>";

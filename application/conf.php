...
$conf['stats'] = "<p>The two scatterplots below represent the distributions of questions in your set. The plot on the left with the blue data points represents individual users, while the plot on the right represents each subject allocation. Within each graph, you may hover over a data point to see specific question counts along with user and subject information. Special thanks to the awesome folks at Google for freely releasing the Chart API that is used here.</p>";
